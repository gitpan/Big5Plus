...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # $1, $2, $3 --> $2, $3, $4
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ebig5plus::ignorecase(Ebig5plus::capture(' . $1 . '))]}';
            }
            else {
                $char[$i] = '${Ebig5plus::capture(' . $1 . ')}';
            }
        ...
        # $$foo[ ... ] --> $ $foo->[ ... ]
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ebig5plus::ignorecase(Ebig5plus::capture(' . $1 . '->' . $2 . '))]}';
            }
            else {
                $char[$i] = '${Ebig5plus::capture(' . $1 . '->' . $2 . ')}';
            }
        ...
        # $scalar or @array
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Ebig5plus::ignorecase(' . e_string($char[$i]) . ')]}';
            }
            else {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        $re = join '', $ope, $delimiter, "$your_gap(?:", @char, '>]}' x ($left_e - $right_e), ')(?{Ebig5plus::m_matched})', $end_delimiter, $modifier;
    }
    else {
        $re = join '', $ope, $delimiter, "$your_gap(?:", @char,                               ')(?{Ebig5plus::m_matched})', $end_delimiter, $modifier;
    }
    return $re;
}
...
sub e_s1 {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        $re = join '', $ope, $delimiter, "($your_gap)(?:", @char, '>]}' x ($left_e - $right_e), ')(?{Ebig5plus::s_matched})', $end_delimiter, $modifier;
    }
    else {
        $re = join '', $ope, $delimiter, "($your_gap)(?:", @char,                               ')(?{Ebig5plus::s_matched})', $end_delimiter, $modifier;
    }
    return $re;
}
