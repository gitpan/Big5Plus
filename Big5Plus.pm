...
sub e_qr {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        $re = join '', $ope, $delimiter, "$your_gap(?:", @char, '>]}' x ($left_e - $right_e), ')(?{$Ebig5plus::last_s_matched=0})', $end_delimiter, $modifier;
    }
    else {
        $re = join '', $ope, $delimiter, "$your_gap(?:", @char,                               ')(?{$Ebig5plus::last_s_matched=0})', $end_delimiter, $modifier;
    }
    return $re;
}
...
sub e_qr_q {
    ...
    $modifier =~ tr/i//d;
    return join '', $ope, $delimiter, "$your_gap(?:", @char, ')(?{$Ebig5plus::last_s_matched=0})', $end_delimiter, $modifier;
}
...
sub e_s1 {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        $re = join '', $ope, $delimiter, "($your_gap)(?:", @char, '>]}' x ($left_e - $right_e), ')(?{$Ebig5plus::last_s_matched=1})', $end_delimiter, $modifier;
    }
    else {
        $re = join '', $ope, $delimiter, "($your_gap)(?:", @char,                               ')(?{$Ebig5plus::last_s_matched=1})', $end_delimiter, $modifier;
    }
    return $re;
}
...
sub e_s1_q {
    ...
    $modifier =~ tr/i//d;
    return join '', $ope, $delimiter, "($your_gap)(?:", @char, ')(?{$Ebig5plus::last_s_matched=1})', $end_delimiter, $modifier;
}
...
In present Japan, Big5Plus is widely used on mainframe I/O, the personal computer,
